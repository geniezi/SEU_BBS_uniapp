<template>
	<view class="commodity-post">
		...
		<view class="commodity-photo"><!--商品图-->
			<u-image class="image" :src="url" width="320px" height="225px" ></u-image>
		</view>
...
<style lang="scss" scoped>
	.commodity-post {
		...
		border-radius: 5px; /* 指定50像素的圆角半径 */
		width: calc(50% - 2px); /* 50%宽度，减去间距 */
	}
	
	.commodity-photo{
		display: flex;
		flex-wrap: wrap;
		height: 225px; /* 假设父容器高度为200px */
		margin-top: 5px;
		margin-bottom: 10px;
